# 📊 Base Transaction Monitor (TypeScript)
...
1. Clone this repository:
   ```bash
   git clone [https://github.com/legend-builds/Base-Tx-Monitor-TS.git](https://github.com/legend-builds/Base-Tx-Monitor-TS.git)
   cd Base-Tx-Monitor-TS
